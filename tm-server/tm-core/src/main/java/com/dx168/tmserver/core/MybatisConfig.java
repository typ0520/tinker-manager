package com.dx168.tmserver.core;
...
@MapperScan(basePackages="com.dx168.tmserver.core.mapper",sqlSessionFactoryRef = "sqlSessionFactory")
public class MybatisConfig {
    ...
    private DataSource getTomcatPoolingDataSource(String databaseUrl, String userName, String password) {
        ...
        dataSource.setInitialSize(10); // 连接池启动时创建的初始化连接数量（默认值为0）
