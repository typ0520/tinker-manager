package com.dx168.patchserver.core;
...
@MapperScan(basePackages="com.dx168.patchserver.core.mapper",sqlSessionFactoryRef = "sqlSessionFactory")
public class MybatisConfig {
    ...
    private DataSource getTomcatPoolingDataSource(String databaseUrl, String userName, String password) {
        ...
        dataSource.setInitialSize(3); // 连接池启动时创建的初始化连接数量（默认值为0）
        dataSource.setMaxActive(30); // 连接池中可同时连接的最大的连接数
